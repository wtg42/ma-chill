# Tile Catalog Specification

## Purpose
Define a canonical, display-agnostic Taiwan Mahjong tile catalog used consistently across parsing, rules, and interoperability workflows.
